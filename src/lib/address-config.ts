...
export interface CountryConfig {
  ...
  taxRate: number; // e.g. 0.05 = 5% VAT (excluding - added on top)
  regions?: string[];
}
...
export const COUNTRY_CONFIG: Record<string, CountryConfig> = {
  AE: {
    code: 'AE', name: 'United Arab Emirates', active: true, currency: 'AED',
    minOrder: 80, deliveryFee: 15, freeDelivery: 150, estimatedDays: 2,
    taxRate: 0.05,
    regions: ['Abu Dhabi', 'Dubai', 'Sharjah', 'Ajman', 'Ras Al Khaimah', 'Fujairah', 'Umm Al Quwain'],
  },
  KW: {
    code: 'KW', name: 'Kuwait', active: true, currency: 'KWD',
    minOrder: 12, deliveryFee: 1.5, freeDelivery: 18, estimatedDays: 3,
    taxRate: 0,
    regions: ['Kuwait City', 'Farwaniya', 'Hawalli', 'Salwa', 'Jabra', 'Salmiya'],
  },
  BH: {
    code: 'BH', name: 'Bahrain', active: true, currency: 'BHD',
    minOrder: 13, deliveryFee: 1.99, freeDelivery: 18, estimatedDays: 2,
    taxRate: 0,
    regions: ['Manama', 'Muharraq', 'Riffa', 'Hamad Town', 'Sitra'],
  },
  SA: {
    code: 'SA', name: 'Saudi Arabia', active: true, currency: 'SAR',
    minOrder: 159, deliveryFee: 19, freeDelivery: 359, estimatedDays: 4,
    taxRate: 0.15,
    regions: ['Riyadh', 'Jeddah', 'Dammam', 'Medina', 'Mecca', 'Khobar', 'Taif', 'Abha'],
  },
  OM: {
    code: 'OM', name: 'Oman', active: true, currency: 'OMR',
    minOrder: 16, deliveryFee: 1.9, freeDelivery: 22, estimatedDays: 3,
    taxRate: 0.05,
    regions: ['Muscat', 'Salalah', 'Nizwa', 'Sohar', 'Barka'],
  },
  QA: {
    code: 'QA', name: 'Qatar', active: true, currency: 'QAR',
    minOrder: 129, deliveryFee: 19, freeDelivery: 299, estimatedDays: 2,
    taxRate: 0,
