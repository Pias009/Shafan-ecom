...
export default function TrendingClient({ products }: TrendingClientProps) {
    ...
    return (
      <div className="min-h-screen bg-white/40 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 pt-32 pb-20 text-center">
          ...
          <h1 className="text-4xl font-black text-black mb-4">Trending Now</h1>
          <p className="text-black/50">No trending products available right now. Check back soon!</p>
          <button
            onClick={() => router.push("/")}
      ...
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-20">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-red-100 px-4 py-2 rounded-full mb-4">
            ...
            <span className="font-black text-sm uppercase tracking-widest text-red-600">Hot</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-black text-black">Trending Now</h1>
          <p className="text-black/60 mt-2">Most popular products right now</p>
        </div>
