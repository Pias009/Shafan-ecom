...
import { Plus, Trash2, Edit2, Check, X, Tag, Upload, Link as LinkIcon } from "lucide-react";
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Offer Banners</h1>
          <p className="text-sm text-black/50 mt-1">Manage promotional offer banners shown on the homepage</p>
        </div>
        <button
      ...
      {showForm && (
        <div className="bg-white rounded-2xl border border-black/10 shadow-sm p-6 space-y-5">
          <h2 className="font-bold text-lg">{editing ? "Edit Banner" : "New Offer Banner"}</h2>
          ...
          <div>
            ...
            {/* Preview — only shown when URL is valid */}
            {previewSrc && (
              <div className="mt-3">
      ...
      {loading ? (
        ...
        <div className="text-center py-16 text-black/40">
          ...
          <p className="font-bold">No offer banners yet.</p>
        </div>
      ) : (
