    ...
    <div className={`group bg-white shadow-lg hover:shadow-2xl transition-all duration-300 rounded-2xl overflow-hidden ${cardWidth} mx-auto flex flex-col`}>
      ...
      <div className="relative overflow-hidden aspect-square w-full bg-[#F9FAFB] flex-shrink-0 p-4">
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none flex flex-col items-center justify-center">
          ...
          <div className={`flex flex-col ${compact ? 'gap-1.5 sm:gap-2' : 'gap-2 sm:gap-3'} transition-all duration-600 ease-out delay-200 opacity-0 group-hover:opacity-100 ${compact ? 'translate-y-2' : 'translate-y-4'} group-hover:translate-y-0`}>
            <button
              type="button"
