...
export function NoticeBoard() {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-amber-50 to-orange-50 border-b border-amber-200 py-2 px-4 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-center relative">
        ...
        <button
          ...
          className="absolute left-0 text-amber-600 hover:text-amber-800 p-1"
            ...
            {notices.map((_, idx) => (
              <button
                ...
                className={`w-1.5 h-1.5 rounded-full transition-all ${
                  idx === currentNoticeIndex ? 'bg-amber-600' : 'bg-amber-300'
                }`}
        ...
        <button
          ...
          className="absolute right-0 text-amber-600 hover:text-amber-800 p-1"
        ...
        <button
          ...
          className="absolute right-4 text-amber-500 hover:text-amber-700 p-1"
