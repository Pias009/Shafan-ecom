    ...
    <div className="relative" ref={containerRef}>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[999999] pointer-events-none">
          <div className="absolute top-full right-0 mt-2 w-48 glass-panel-heavy rounded-2xl p-2 border border-black/5 shadow-2xl z-[999999] bg-white/95 backdrop-blur-xl transition-all animate-in fade-in zoom-in duration-200 pointer-events-auto">
