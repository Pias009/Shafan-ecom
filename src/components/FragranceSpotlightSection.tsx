      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            // noop — keeps parity with other sections
          }
        });
      },
      { threshold: 0.15 }
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[1536px] mx-auto flex flex-col items-center">
        ...
        {/* Fragrance Products 3D Coverflow Stepper Slider */}
        <div className="relative w-full py-2 select-none">
          ...
          >
            ...
            <div className="relative w-full h-full flex items-center justify-center overflow-visible">
              {fragranceProducts.map((product: any, i) => {
                ...
                const fragrancePrice = resolved.displayPrice;
                const fragranceOriginalPrice = resolved.originalPrice;
                const fragranceHasDiscount = resolved.hasDiscount && resolved.originalPrice > fragrancePrice;
                const fragranceCurrency = resolved.currency;
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="relative flex-1 w-full min-h-0 flex items-center justify-center p-1 sm:p-4">
                        <Image
                          src={imgSrc}
                          alt={product.name || "Fragrance Product"}
                          fill
          ...
          <div className="mt-5 sm:mt-8 flex flex-col items-center justify-center gap-2.5 select-none max-w-md mx-auto px-4">
            ...
            <div className="flex items-center gap-2 text-xs sm:text-sm font-sans text-slate-600 tracking-normal">
              ...
              <span className="text-slate-900 font-medium">{fragranceProducts[activeIndex]?.name}</span>
            </div>
